...
const VEHICLE_CATALOG = {
    'a4': {
        ...
        badge: 'New Arrival', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Audi_A4_35_TDI_S_Line_8W_FL_Manhattan_Grey_Metallic_(1).jpg?width=800',
    ...
    'x5': {
        ...
        badge: 'Hot Deal', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/BMW_G05_X5_xDrive45e_M_Sport_Black_Sapphire_Metallic_(2).jpg?width=800',
    ...
    '3-series': {
        ...
        badge: 'Premium', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/BMW_330i_G20_Black_3.jpg?width=800',
    ...
    'range-rover-sport': {
        ...
        badge: 'Hot Deal', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/LAND_ROVER_RANGE_ROVER_SPORT_(L494)_China_(10).jpg?width=800',
    ...
    'c200': {
        ...
        badge: 'Luxury', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mercedes-Benz_C_200_AVANTGARDE_(W206).jpg?width=800',
    ...
    'hiace': {
        ...
        badge: 'Best Seller', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Toyota_Hiace_2.8_GL_Grandia_Tourer_2022.jpg?width=800',
    ...
    'ranger': {
        ...
        badge: 'Popular', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/2022_Ford_Ranger_XLT_Double-Cab_2.0L_Turbo_Hi-Rider.jpg?width=800',
    ...
    'corolla': {
        ...
        badge: 'Value Pick', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/2023_Toyota_Corolla_Altis_1.8_Sport.jpg?width=800',
    ...
    'touareg': {
        ...
        badge: 'Premium', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/2018_Volkswagen_Touareg_V6_R-Line_TDi_Automatic_3.0_Front.jpg?width=800',
    ...
    'vito': {
        ...
        badge: 'Luxury', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mercedes-Benz_Vito_Tourer_114_CDI_IAA_2016_(03)_Travelarz.JPG?width=800',
    ...
    'hilux': {
        ...
        badge: 'Hot Deal', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Toyota_HiLux_AN120-AN130_Crew_Cab.jpg?width=800',
    ...
    'lancer-evo-x': {
        ...
        badge: 'Sport', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mitsubishi_Lancer_Evolution_X_MR.jpg?width=800',
    ...
    'hr-v': {
        ...
        badge: 'Popular', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/2023_Honda_HR-V_1.5_S_in_Meteoroid_Gray_Metallic,_06-22-2024.jpg?width=800',
    ...
    'sylphy': {
        ...
        badge: 'Eco', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Nissan_Sylphy_B18_002.jpg?width=800',
    ...
    'ranger-wildtrak': {
        ...
        badge: 'New', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ford_Ranger_(T6,_P703)_Wildtrak_IMG_7320.jpg?width=800',
    ...
    'isuzu-nqr': {
        ...
        badge: 'Heavy Duty', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Isuzu_NQR_Elf_Dropside_Cargo_2022.jpg?width=800',
    ...
    return `
        <div class="vehicle-card" data-cat="${cat}" data-model="${id}" data-brand="${brand}" data-year="${data.year || ''}" data-condition="${(data.condition || '').toLowerCase()}" data-price="${data.priceNum || 0}" data-fuel="${(data.fuel || '').toLowerCase()}" data-anim>
            <div class="vehicle-card-img">
                <img src="${data.image || SKARA_DEFAULT_IMAGE}" alt="${data.title || 'Vehicle'}" width="800" height="500" loading="lazy" decoding="async">
...
function loadVehicleDetailPage() {
    ...
    if (/Special:FilePath/.test(heroImage)) {
        heroImage = /[?&]width=/.test(heroImage)
            ? heroImage.replace(/([?&]width=)\d+/, (_, prefix) => prefix + '1200')
            : heroImage + (heroImage.includes('?') ? '&' : '?') + 'width=1200';
    } else {
        heroImage = heroImage.replace(/([?&])h=600\b/, '$1h=900').replace(/([?&])w=800\b/, '$1w=1400');
    }
    if (mainImage) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    // 1. STICKY HEADER (search bar scrolls with page — not pinned)
    // ==========================================
    ...
    function collapseMobileFilter(visibleCount) {
        ...
        bar.classList.add('search-collapsed');
    ...
    function expandMobileFilter() {
        const bar = document.getElementById('vehicleFilterBar');
        const summary = document.getElementById('filterMobileSummary');
        bar?.classList.remove('search-collapsed');
